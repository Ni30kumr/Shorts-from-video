...
def separate_vocals_and_instruments(output_dir="", sr=44100, n_fft=2048, hop_length=1024, 
                                    batchsize=4, cropsize=256, postprocess=False, tta=False, 
                                    output_image=False, gpu=-1):
    ...
    X, sr = librosa.load(f'C:/Users/Dell/SHL2/{output_dir}/audio.mp3', sr=sr, mono=False, dtype=np.float32, res_type='kaiser_fast')
    basename = os.path.splitext(os.path.basename(f'C:/Users/Dell/SHL2/{output_dir}/audio.mp3'))[0]
    print('done')
    ...
    print('done')
    sf.write(f'C:/Users/Dell/SHL2/{output_dir}/Instruments.wav', wave.T, sr)

    print('inverse stft of vocals...', end=' ')
    wave = spec_utils.spectrogram_to_wave(v_spec, hop_length=hop_length)
    print('done')
    sf.write(f'C:/Users/Dell/SHL2/{output_dir}/Vocals.wav', wave.T, sr)
    ...
    print(f"Separation complete. Output files saved in: {output_dir or '.'}")

# Example usage
if __name__ == '__main__':
    input_path = 'C:/Users/Dell/SHL2/audio.mp3'
    separate_vocals_and_instruments('piyush')
